...
function startPlotUpdates(): void {
...
const loadGeometryView = async () => {
  ...
  try {
    ...
    if (info.success) {
      ...
      if (div) div.textContent = `Bounds: [${info.bounds.join(", ")}]`;
