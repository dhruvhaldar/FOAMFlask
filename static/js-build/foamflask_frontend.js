...
const createBoldTitle = (text) => ({
    ...
    font: Object.assign(Object.assign({}, plotLayout === null || plotLayout === void 0 ? void 0 : plotLayout.font), { size: 22 })
});
// --- Helper: Download plot as PNG with white background ---
function downloadPlotAsPNG(plotDiv, filename = 'plot.png') {
    if (!plotDiv)
        return;
    const downloadLayout = Object.assign(Object.assign({}, plotDiv.layout), { font: Object.assign(Object.assign({}, plotLayout.font), { color: 'black' }), plot_bgcolor: 'white', paper_bgcolor: 'white' });
...
function attachWhiteBGDownloadButton(plotDiv) {
    ...
    const configWithWhiteBG = Object.assign({}, ((_a = plotDiv._fullLayout) === null || _a === void 0 ? void 0 : _a.config) || plotConfig || {});
...
window.onload = () => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        const [caseRootData, dockerConfigData] = yield Promise.all([
...
function setCase() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield fetch("/set_case", {
                method: "POST",
...
function setDockerConfig(image, version) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield fetch("/set_docker_config", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
...
function loadTutorial() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield fetch("/load_tutorial", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
...
function runCommand(cmd) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield fetch("/run", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    caseDir: caseDir,
...
function updatePlots() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const data = yield fetchWithCache(`/api/plot_data?tutorial=${encodeURIComponent(selectedTutorial)}`);
            if (data.error) {
            ...
            if (data.p && data.time) {
                ...
                const pressureTrace = {
                    ...
                    mode: 'lines',
                    name: 'Pressure',
                    line: Object.assign(Object.assign({ color: plotlyColors.blue }, lineStyle), { width: 2.5 }),
                };
                ...
                Plotly.react(pressureDiv, [pressureTrace], Object.assign(Object.assign({}, plotLayout), { title: createBoldTitle('Pressure vs Time'), xaxis: Object.assign(Object.assign({}, plotLayout.xaxis), { title: 'Time (s)' }), yaxis: Object.assign(Object.assign({}, plotLayout.yaxis), { title: 'Pressure (Pa)' }) }), plotConfig).then(() => attachWhiteBGDownloadButton(pressureDiv));
            }
            // --- Velocity plot ---
            if (data.U_mag && data.time) {
                ...
                const traces = [
                    {
                        ...
                        mode: 'lines',
                        name: '|U|',
                        line: Object.assign(Object.assign({ color: plotlyColors.red }, lineStyle), { width: 2.5 })
                    }
                ];
                if (data.Ux) {
                    traces.push({
                        ...
                        mode: 'lines',
                        name: 'Ux',
                        line: Object.assign(Object.assign({ color: plotlyColors.blue }, lineStyle), { dash: 'dash', width: 2.5 })
                    });
                }
                if (data.Uy) {
                    traces.push({
                        ...
                        mode: 'lines',
                        name: 'Uy',
                        line: Object.assign(Object.assign({ color: plotlyColors.green }, lineStyle), { dash: 'dot', width: 2.5 })
                    });
                }
                if (data.Uz) {
                    traces.push({
                        ...
                        mode: 'lines',
                        name: 'Uz',
                        line: Object.assign(Object.assign({ color: plotlyColors.purple }, lineStyle), { dash: 'dashdot', width: 2.5 })
                    });
                }
                // Apply saved visibility to the new trace
                ...
                Plotly.react(velocityDiv, traces, Object.assign(Object.assign({}, plotLayout), { title: createBoldTitle('Velocity vs Time'), xaxis: Object.assign(Object.assign({}, plotLayout.xaxis), { title: 'Time (s)' }), yaxis: Object.assign(Object.assign({}, plotLayout.yaxis), { title: 'Velocity (m/s)' }) }), plotConfig).then(() => attachWhiteBGDownloadButton(velocityDiv));
            }
            // --- Turbulence plot ---
            const turbTraces = [];
            if (data.nut && data.time) {
                turbTraces.push({
                    ...
                    mode: 'lines',
                    name: 'nut',
                    line: Object.assign(Object.assign({ color: plotlyColors.teal }, lineStyle), { width: 2.5 }),
                });
            }
            if (data.nuTilda && data.time) {
                turbTraces.push({
                    ...
                    mode: 'lines',
                    name: 'nuTilda',
                    line: Object.assign(Object.assign({ color: plotlyColors.cyan }, lineStyle), { width: 2.5 }),
                });
            }
            if (data.k && data.time) {
                turbTraces.push({
                    ...
                    mode: 'lines',
                    name: 'k',
                    line: Object.assign(Object.assign({ color: plotlyColors.magenta }, lineStyle), { width: 2.5 }),
                });
            }
            if (data.omega && data.time) {
                turbTraces.push({
                    ...
                    mode: 'lines',
                    name: 'omega',
                    line: Object.assign(Object.assign({ color: plotlyColors.brown }, lineStyle), { width: 2.5 }),
                });
            }
            if (turbTraces.length > 0) {
                Plotly.react('turbulence-plot', turbTraces, Object.assign(Object.assign({}, plotLayout), { title: createBoldTitle('Turbulence Properties vs Time'), xaxis: Object.assign(Object.assign({}, plotLayout.xaxis), { title: 'Time (s)' }), yaxis: Object.assign(Object.assign({}, plotLayout.yaxis), { title: 'Value' }) }), plotConfig).then(() => attachWhiteBGDownloadButton(document.getElementById('turbulence-plot')));
            }
...
function updateResidualsPlot(tutorial) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const data = yield fetchWithCache(`/api/residuals?tutorial=${encodeURIComponent(tutorial)}`);
            ...
            if (traces.length > 0) {
                const layout = Object.assign(Object.assign({}, plotLayout), { title: createBoldTitle('Residuals'), xaxis: {
                        title: {
                            text: 'Iteration',
                        },
                        showline: true,
                ...
                Plotly.react('residuals-plot', traces, layout, Object.assign(Object.assign({}, plotConfig), { displayModeBar: true, scrollZoom: false })).then(() => attachWhiteBGDownloadButton(document.getElementById('residuals-plot')));
            }
        }
        catch (err) {
...
function updateAeroPlots() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!selectedTutorial)
            return;
        try {
            const response = yield fetch(`/api/latest_data?tutorial=${encodeURIComponent(selectedTutorial)}`);
            const data = yield response.json();
            if (data.error)
                return;
            // --- Cp plot ---
            if (Array.isArray(data.p) && Array.isArray(data.time) && data.p.length === data.time.length && data.p.length > 0) {
                ...
                if (cpDiv) {
                    ...
                    Plotly.react(cpDiv, [cpTrace], Object.assign(Object.assign({}, plotLayout), { title: createBoldTitle('Pressure Coefficient'), xaxis: { title: 'Time (s)' }, yaxis: { title: 'Cp' } }), plotConfig).then(() => attachWhiteBGDownloadButton(cpDiv));
                }
            }
            ...
            if (Array.isArray(data.Ux) && Array.isArray(data.Uy) && Array.isArray(data.Uz)) {
                ...
                if (velocityDiv) {
                    ...
                    Plotly.react(velocityDiv, [velocityTrace], Object.assign(Object.assign({}, plotLayout), { title: createBoldTitle('Velocity Profile'), scene: { xaxis: { title: 'Ux' }, yaxis: { title: 'Uy' }, zaxis: { title: 'Uz' } } }), plotConfig);
...
function downloadPlotData(plotId, filename) {
    ...
    traces.forEach((trace, index) => {
        ...
        for (let i = 0; i < trace.x.length; i++) {
            const x = (_a = trace.x[i]) !== null && _a !== void 0 ? _a : '';
            const y = (_b = trace.y[i]) !== null && _b !== void 0 ? _b : '';
            csvContent += `${x},${y}\n`;
        }
        // Generate filename based on trace name
        const traceName = ((_c = trace.name) === null || _c === void 0 ? void 0 : _c.replace(/\s+/g, '_').toLowerCase()) || `trace_${index + 1}`;
...
function refreshMeshList() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield fetch(`/api/available_meshes?tutorial=${encodeURIComponent(tutorial)}`);
            if (!response.ok) {
...
function runFoamToVTK() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield fetch("/run_foamtovtk", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                    caseDir: caseDir,
...
function loadMeshVisualization() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const infoResponse = yield fetch('/api/load_mesh', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
            ...
            const meshInfo = yield infoResponse.json();
            if (!meshInfo.success) {
...
function updateMeshView() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield fetch('/api/mesh_screenshot', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
...
function displayMeshInfo(meshInfo) {
    ...
    const infoItems = [
        { label: 'Points', value: ((_a = meshInfo.n_points) === null || _a === void 0 ? void 0 : _a.toLocaleString()) || 'N/A' },
        { label: 'Cells', value: ((_b = meshInfo.n_cells) === null || _b === void 0 ? void 0 : _b.toLocaleString()) || 'N/A' },
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isInteractiveMode) {
            ...
            try {
                ...
                const response = yield fetch('/api/mesh_interactive', {
                    method: 'POST',
                    headers: {
...
function runPostOperation(operation) {
    return __awaiter(this, void 0, void 0, function* () {
...
function loadSelectedVTK() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const response = yield fetch('/api/load_mesh', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ file_path: selectedFile })
            });
            const meshInfo = yield response.json();
            if (meshInfo.success) {
...
function loadCustomVTKFile() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield fetch('/api/upload_vtk', {
                method: 'POST',
                body: formData
            });
