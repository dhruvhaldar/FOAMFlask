...
#         """Test the api_available_fields endpoint."""
#         # Set up a test case directory with time directories
#         time_dir = test_case_dir / "0.1"
#         time_dir.mkdir()
#         (time_dir / "U").touch()
#         (time_dir / "p").touch()
...
#         response = client.get('/api/available_fields?tutorial=test_tutorial&caseDir=test_case')
#         assert response.status_code == 200
#         data = json.loads(response.data)
...
#     def test_api_plot_data(self, client, test_case_dir):
#         """Test the api_plot_data endpoint."""
#         # Set up a test case directory with time directories and field files
#         time_dir = test_case_dir / "0.1"
#         time_dir.mkdir()
...
#         # Add required parameters
#         response = client.get('/api/plot_data?tutorial=test_tutorial&caseDir=test_case')
#         assert response.status_code == 200
#         data = json.loads(response.data)
#         assert 'time' in data
#         assert 'data' in data
