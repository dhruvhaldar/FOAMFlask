...
# ⚡ Bolt Optimization: Cache regex compilation for variable resolution
# This avoids recompiling patterns for the same variables (e.g. $inletValue)
# which can happen frequently during file parsing.
@lru_cache(maxsize=128)
def _get_variable_pattern(clean_var: Union[str, bytes]) -> re.Pattern:
    """Get or compile a regex pattern for resolving a variable."""
